var crypto = require('crypto'),
    ...
    hashids = new Hashids(config.passSalt),
    initPage = '/';
...
var commons = {
    ...
    createNoteCode : function (noteID) {
        return hashids.encryptHex(noteID);
    },
    
    getNoteID : function (noteCode) {
        return hashids.decryptHex(noteCode);
    },
